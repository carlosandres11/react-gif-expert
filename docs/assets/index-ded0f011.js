...
const Rd = ({ onNewCategory: e }) => {
  ...
  Od = ({ id: e, title: n, url: t }) =>
    Z.jsxs("div", {
      className: "card",
      children: [
        Z.jsx("img", { src: t, alt: "title" }),
        Z.jsx("p", { children: n }),
      ],
    }),
  Md = async (e) => {
    const t = `https://api.giphy.com/v1/gifs/search?api_key=FmpXYpA11Yx71jdZKht597lujPgHq3eV&q=${e}&limit=10`,
      r = await fetch(t),
      { data: l } = await r.json(),
      u = l.map((o) => ({
        id: o.id,
  ...
  jd = () => {
    const [e, n] = tn.useState(["One Punch"]),
      t = (r) => {
        e.includes(r) || n([r, ...e]);
      };
    return Z.jsxs(Z.Fragment, {
      children: [
        Z.jsx("h1", { children: "GifExpertASpp" }),
        Z.jsx(Rd, { onNewCategory: (r) => t(r) }),
        e.map((r) => Z.jsx(Dd, { category: r }, r)),
      ],
    });
  };
